...
const sections = [
  ...
  },
  {
    ...
    content: [
      {
        type: "text",
        body: "初期設定を完了した当日は「サンプル日」として扱われます。アプリの使い方を気軽に試せる練習日です。",
      },
      {
        type: "status-items",
        items: [
          {
            icon: "🎓",
            label: "サンプル日の動作",
            desc: "タスクをタップしてポイントを獲得できますが、そのデータは週間グラフには記録されません。翌日から本番のデータ蓄積が始まります。",
          },
          {
            icon: "📊",
            label: "週間グラフへの影響",
            desc: "「今週の経過」タブのグラフは翌日以降から記録されます。サンプル日のスコアはグラフに表示されません。",
          },
          {
            icon: "✅",
            label: "翌日からの本番スタート",
            desc: "翌日になると自動的に通常モードに切り替わり、その日からのデータが週間グラフに蓄積されていきます。",
          },
        ],
      },
      {
        ...
        items: [
          "サンプル日は設定当日の1日だけです",
          "サンプル日中はバナーが表示されます（「今日はサンプル日です」）",
          "翌日以降はバナーが消え、通常通りデータが記録されます",
          "サンプル日でも早起きボーナスや各タスクは通常通り試せます",
        ],
      },
    ],
  },
